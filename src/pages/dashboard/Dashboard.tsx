...
import { Briefcase, Folder, Mail, Users } from 'lucide-react';
    ...
    <div className="min-h-screen bg-gray-50 text-gray-800 p-6">
      ...
      <div className="container mx-auto max-w-6xl py-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          {/* Projects Card */}
          <div className="bg-white rounded-lg border border-gray-300 shadow-sm p-6 hover:shadow-md transition cursor-pointer">
            <div className="flex items-center gap-4">
          ...
          <div className="bg-white rounded-lg border border-gray-300 shadow-sm p-6 hover:shadow-md transition cursor-pointer">
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-gray-600 text-sm">Manage admin users</p>
              </div>
            </div>
          </div>
        </div>
